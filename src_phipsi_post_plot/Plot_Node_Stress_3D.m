...
for i_Plot = Start_Dis_Type:End_Dis_Type
	...
	if i_Plot == 1
	    disp('    > Plotting nodal stress-xx contour....') 
	    title('Stress-xx contour','FontName',Title_Font,'FontSize',Size_Font)
        ...
        for iElem=1:num_plot_el
            ...
            XYZ{iElem} = [X Y Z];
            profile{iElem} = Stress_Matrix(nd,2);
        end
	...
	elseif i_Plot == 2
	    disp('    > Plotting nodal stress-yy contour....') 
	    title('Stress-yy contour','FontName',Title_Font,'FontSize',Size_Font)
        fm = [1 2 6 5; 2 3 7 6; 3 4 8 7; 4 1 5 8; 1 2 3 4; 5 6 7 8];
        XYZ = cell(1,num_plot_el);
        profile = XYZ;
        ...
        for iElem=1:num_plot_el
            ...
            Z = New_Node_Coor(nd,3);
            XYZ{iElem} = [X Y Z] ;
            profile{iElem} = Stress_Matrix(nd,3);
        end
        cellfun(@patch,repmat({'Vertices'},1,num_plot_el),XYZ,.......
            repmat({'Faces'},1,num_plot_el),repmat({fm},1,num_plot_el),......
            repmat({'FaceVertexCdata'},1,num_plot_el),profile,......
		...
		set(gca,'XTick',[]) ; set(gca,'YTick',[]); set(gca,'ZTick',[]);		
	elseif i_Plot == 3
	    disp('    > Plotting nodal stress-zz contour....') 
	    title('Stress-zz contour','FontName',Title_Font,'FontSize',Size_Font)
        fm = [1 2 6 5; 2 3 7 6; 3 4 8 7; 4 1 5 8; 1 2 3 4; 5 6 7 8];
        XYZ = cell(1,num_plot_el);
        profile = XYZ;
        ...
        for iElem=1:num_plot_el
            ...
            Z = New_Node_Coor(nd,3);
            XYZ{iElem} = [X Y Z] ;
            profile{iElem} = Stress_Matrix(nd,4);
        end
        cellfun(@patch,repmat({'Vertices'},1,num_plot_el),XYZ,.......
            repmat({'Faces'},1,num_plot_el),repmat({fm},1,num_plot_el),......
            repmat({'FaceVertexCdata'},1,num_plot_el),profile,......
		...
		set(gca,'XTick',[]) ; set(gca,'YTick',[]); set(gca,'ZTick',[]) ;	
	elseif i_Plot == 4
	    disp('    > Plotting nodal stress-xy contour....') 
	    title('Stress-xy contour','FontName',Title_Font,'FontSize',Size_Font)
        fm = [1 2 6 5; 2 3 7 6; 3 4 8 7; 4 1 5 8; 1 2 3 4; 5 6 7 8];
        XYZ = cell(1,num_plot_el);
        profile = XYZ;
        ...
        for iElem=1:num_plot_el
            ...
            Z = New_Node_Coor(nd,3);
            XYZ{iElem} = [X Y Z] ;
            profile{iElem} = Stress_Matrix(nd,5);
        end
        cellfun(@patch,repmat({'Vertices'},1,num_plot_el),XYZ,.......
            repmat({'Faces'},1,num_plot_el),repmat({fm},1,num_plot_el),......
            repmat({'FaceVertexCdata'},1,num_plot_el),profile,......
		...
		set(gca,'XTick',[]) ; set(gca,'YTick',[]); set(gca,'ZTick',[]) ;			
	elseif i_Plot == 5
	    disp('    > Plotting nodal stress-yz contour....') 
	    title('Stress-yz contour','FontName',Title_Font,'FontSize',Size_Font)
        fm = [1 2 6 5; 2 3 7 6; 3 4 8 7; 4 1 5 8; 1 2 3 4; 5 6 7 8];
        XYZ = cell(1,num_plot_el);
        profile = XYZ;
        ...
        for iElem=1:num_plot_el
            ...
            Z = New_Node_Coor(nd,3);
            XYZ{iElem} = [X Y Z];
            profile{iElem} = Stress_Matrix(nd,6);
        end
        cellfun(@patch,repmat({'Vertices'},1,num_plot_el),XYZ,.......
            repmat({'Faces'},1,num_plot_el),repmat({fm},1,num_plot_el),......
            repmat({'FaceVertexCdata'},1,num_plot_el),profile,......
		...
		set(gca,'XTick',[]) ; set(gca,'YTick',[]); set(gca,'ZTick',[]) ;			
	elseif i_Plot == 6
	    disp('    > Plotting nodal stress-xz contour....') 
	    title('Stress-xz contour','FontName',Title_Font,'FontSize',Size_Font)
        fm = [1 2 6 5; 2 3 7 6; 3 4 8 7; 4 1 5 8; 1 2 3 4; 5 6 7 8];
        XYZ = cell(1,num_plot_el) ;
        profile = XYZ;
        ...
        for iElem=1:num_plot_el
            ...
            Z = New_Node_Coor(nd,3);
            XYZ{iElem} = [X Y Z];
            profile{iElem} = Stress_Matrix(nd,7);
        end
        cellfun(@patch,repmat({'Vertices'},1,num_plot_el),XYZ,.......
            repmat({'Faces'},1,num_plot_el),repmat({fm},1,num_plot_el),......
            repmat({'FaceVertexCdata'},1,num_plot_el),profile,......
		...
		set(gca,'XTick',[]) ; set(gca,'YTick',[]); set(gca,'ZTick',[]) ;		
	elseif i_Plot == 7
	    disp('    > Plotting nodal stress-Mises contour....') 
	    title('Stress-Mises contour','FontName',Title_Font,'FontSize',Size_Font)
        fm = [1 2 6 5; 2 3 7 6; 3 4 8 7; 4 1 5 8; 1 2 3 4; 5 6 7 8];
        XYZ = cell(1,num_plot_el);
        profile = XYZ;
        ...
        for iElem=1:num_plot_el
            ...
            Z = New_Node_Coor(nd,3);
            XYZ{iElem} = [X Y Z];
            profile{iElem} = Stress_Matrix(nd,8);
        end
        cellfun(@patch,repmat({'Vertices'},1,num_plot_el),XYZ,.......
            repmat({'Faces'},1,num_plot_el),repmat({fm},1,num_plot_el),......
            repmat({'FaceVertexCdata'},1,num_plot_el),profile,......
